frappe.listview_settings['Sowaan Leave Policy Assignment'] = {
		...
		list_view.page.add_inner_button(__("Bulk Leave Policy Assignment"), function () {
			me.dialog = new frappe.ui.form.MultiSelectDialog({
				...
				action(employees, data) {
					frappe.call({
						method: 'erpnext.hr.doctype.sowaan_leave_policy_assignment.sowaan_leave_policy_assignment.create_assignment_for_multiple_employees',
						async: false,
						args: {
							employees: employees,
							data: data
